    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 80.0, vertical: 40),
              child: Text(
                  "        At Zakat Jahada, our journey began in 2021 with a simple yet profound mission: to spread Islam, extend helping hands to the less fortunate, and foster positive change in communities around the world. Inspired by personal experiences and encounters with various humanitarian challenges, we embarked on a path driven by compassion, empathy, and a commitment to make a difference."
